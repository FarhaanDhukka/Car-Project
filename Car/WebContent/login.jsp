...
<body>
	...
	<jsp:include page="header.jsp"></jsp:include>
			...
			<div class ="form-group">
				...
				<input type="text " name="username"  value="<%out.println(username);%>" class="form-control" placeholder="Enter Username">
			</div>
			...
			<div class ="form-group">
				...
				<input type="reset" value="Register"class="btn btn-danger btn-block"/>
			</div>
